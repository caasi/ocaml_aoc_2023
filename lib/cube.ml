...
let red =
  lift (fun x -> (int_of_string x, 0, 0)) digits <* space <* string "red"

let green =
  lift (fun x -> (0, int_of_string x, 0)) digits <* space <* string "green"

let blue =
  lift (fun x -> (0, 0, int_of_string x)) digits <* space <* string "blue"
